...
namespace Crunch
{
    public class TextHudModule
    {
        ...
        HudAPIv2.HUDMessage HUD_Other;
        StringBuilder OtherText = new StringBuilder("Other");

        HudAPIv2.HUDMessage HUD_Test;
        StringBuilder TestText = new StringBuilder("Test");
        ...
        {
            // Init status line
            HUD_Other = new HudAPIv2.HUDMessage(OtherText, new Vector2D(0.75, 0.95), null, -1, 1.25, true, false, null, BlendTypeEnum.PostPP, "white");

            // Init info line
            HUD_Test = new HudAPIv2.HUDMessage(TestText, new Vector2D(0.75, 0.90), null, -1, 1.25, true, false, null, BlendTypeEnum.PostPP, "white");
